...
public class cocomo2_early_design_logic {

    public static BigDecimal calculate_early_design_stage(double kloc, List<String> SF_parameters, List<String> EM_parameters){
        double a = 2.94;
        double b = 0.91;
        double SFj = 0.0;
        double EAF = 1;
